...
const baseKnowledge: KnowledgeEntry[] = [
  { category: 'greeting', pattern: 'hello|hi|hey|greetings', response: 'Hello! I am FormatUI. How can I help you today?', weight: 10 },
...
// Example usage
const sample = { name: 'FormatUI', type: 'AI' };
console.log(processData(sample));
\`\`\`

*Generated by FormatUI - Customize as needed!*`;
    }
...
---
*Template generated by FormatUI*`;
  }
